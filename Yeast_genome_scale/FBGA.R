...
#nperm <- 10000
#set.seed(1234)
#rankSum = sapply(1:nperm, function(i){
#sum(sample(1:109, size = length(GS_regulation_support$rank[!is.na(GS_regulation_support$rank)]), replace = T))
#})
#1 - sum(sum(GS_regulation_support$rank, na.rm = T) < rankSum)/nperm
