...
mode_of_regulation <- function(adequate_rxn_form_data){
  ...
  regulated_rxns <- reactionInfo %>% filter(rMech %in% adequate_fit_optimal_rxn_form) %>% filter(modelType %in% c("regulator", "coopertivity")) %>%
