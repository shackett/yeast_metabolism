...
Overlap_lattice$RowBlock <- proteomicsBlocking$Block[Overlap_lattice$Row]
Overlap_lattice$ColBlock <- proteomicsBlocking$Block[Overlap_lattice$Column]
...
IntersectVsUnion <- ggplot(Overlap_lattice, aes(Rowsample, Colsample, fill = IntersectVsUnion)) + facet_grid(RowInstrument + RowSet ~ ColInstrument + ColSet) + tile_theme
...
IntersectVsUnion <- ggplot(set2block, aes(Rowsample, Colsample, fill = IntersectVsUnion)) + tile_theme
...
IntersectVsUnion <- ggplot(Overlap_lattice, aes(Rowsample, Colsample, fill = Intersection)) + facet_grid(RowInstrument + RowSet ~ ColInstrument + ColSet) + tile_theme
...
heatmap.2(IntersectVsUnion, Colv = FALSE, Rowv = FALSE, trace = "none", col = blue2yellow(100), dendrogram = "none")
@

<<missingOverlap2, dependson = "mvmat", label = "missingOverlap2", echo = FALSE, include = FALSE, cache = TRUE>>=
heatmap.2(pMatchAB, Colv = FALSE, Rowv = FALSE, trace = "none", col = blue2yellow(100), dendrogram = "none")
@
