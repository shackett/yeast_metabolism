...
\begin{figure}
<<globalPTregressed, dependson = "PTcor", echo = FALSE>>=
library(reshape)
...
#write.table(localDF_Eweight, file = "localDF_Eweight.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
