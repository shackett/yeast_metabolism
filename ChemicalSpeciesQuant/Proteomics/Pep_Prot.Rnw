...
proteomicsBlcking <- read.table("proteomicsBlocking.tsv", header = TRUE)
...
binPepMatrixH <- ifelse(is.finite(heavyIC), 1, 0)
...
heatmap.2(Intersection, Colv = FALSE, Rowv = FALSE, trace = "none", col = blue2yellow(100), dendrogram = "none")
@
