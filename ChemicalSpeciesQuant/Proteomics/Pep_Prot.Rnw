...
<<mv_impute, dependson = "EMrun", cache = TRUE>>=
library(missMDA)
...
<<plot_proteinTrends, dependson = "mv_impute", cache = TRUE, warning = FALSE>>=
...
<<>>=
plot_protein_lattice(c(1:25), possibleMap, prot_abund_final, prot_prec, uniquePepMean, uniquePepPrecision, mixing_fract)
@

<<>>=
plot_protein_lattice(c(26:50), possibleMap, prot_abund_final, prot_prec, uniquePepMean, uniquePepPrecision, mixing_fract)
@
...
<<ModifyTransc, dependson = "mv_impute">>=
library("missMDA")
