...
Description of Lowess normalization - correcting for local dependence of log2(H/L) on log10(H*L) - saturation effects, not really present in MS data - check for each sample
...
\item Some peptides wonÕt conform to the trends of their protein because they may be the non-covalently modified complement of a set of unascertained modified peptides. These peptides shouldnÕt inform the general protein trend, and may be interesting to analyze in isolation.
